<?php
/* 
 * TopGolf GetLocations Snippet
 * Version 2.0 
 * Author - Updated by John Peca (john@modx.com)
 * Usage - Locations Template
*/ 
$contexts = array();
...
$tplRow = $modx->getOption('tplRow', $scriptProperties, 'LocationRowTpl');
$tplOuter = $modx->getOption('tplOuter', $scriptProperties, 'LocationOuterTpl');
$tplLoadMore = $modx->getOption('tplLoadMore', $scriptProperties, 'LocationloadMoreTpl');
